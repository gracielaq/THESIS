...
public static String Earthquake(tempBean temp){
	...
	if(temp.getBilangNgNawawala()!=null & temp.getBilangNgSugatan()!=null & temp.getBilangNgNamatay()!=null & temp.getMagnitude()!=null & temp.getLugar()!=null){
        return("Ayon sa reports, may " +temp.getBilangNgNamatay()+", " +temp.getBilangNgSugatan()+ " at "+temp.getBilangNgNawawala() + " matapos tumama ang " +temp.getMagnitude() + " na lindol sa " + temp.getLugar()) + " noong " + convertDate(temp.getPetsa());
	} else if(temp.getBilangNgNawawala()!=null & temp.getBilangNgSugatan()!=null & temp.getMagnitude()!=null & temp.getLugar()!=null){
        return("Ayon sa reports, may " + temp.getBilangNgNawawala()+ " at "+temp.getBilangNgSugatan() + " matapos tumama ang " +temp.getMagnitude() + " na lindol sa " + temp.getLugar()) + " noong " + convertDate(temp.getPetsa());
    } else if(temp.getBilangNgSugatan()!=null & temp.getBilangNgNamatay()!=null & temp.getMagnitude()!=null & temp.getLugar()!=null){
        return("Ayon sa reports, may " +temp.getBilangNgNamatay() + " at "+temp.getBilangNgSugatan() + " matapos tumama ang " +temp.getMagnitude() + " na lindol sa " + temp.getLugar()) + " noong " + convertDate(temp.getPetsa());
    } else if(temp.getBilangNgNawawala()!=null  & temp.getBilangNgNamatay()!=null & temp.getMagnitude()!=null & temp.getLugar()!=null){
        return("Ayon sa reports, may " +temp.getBilangNgNamatay() + " at " +temp.getBilangNgNawawala() + " matapos tumama ang " +temp.getMagnitude() + " na lindol sa " + temp.getLugar()) + " noong " + convertDate(temp.getPetsa());
    } else if(temp.getBilangNgNamatay()!=null & temp.getMagnitude()!=null & temp.getLugar()!=null){
        return("Ayon sa reports, may " +temp.getBilangNgNamatay() + " matapos tumama ang " +temp.getMagnitude() + " na lindol sa " + temp.getLugar()) + " noong " + convertDate(temp.getPetsa());
    } else if(temp.getBilangNgSugatan()!=null & temp.getMagnitude()!=null & temp.getLugar()!=null){
        return("Ayon sa reports, may " +temp.getBilangNgSugatan() + " matapos tumama ang " +temp.getMagnitude() + " na lindol sa " + temp.getLugar()) + " noong " + convertDate(temp.getPetsa());
    } else if(temp.getBilangNgNawawala()!=null & temp.getMagnitude()!=null & temp.getLugar()!=null){
        return("Ayon sa reports, may " +temp.getBilangNgNawawala() + " matapos tumama ang " +temp.getMagnitude() + " na lindol sa " + temp.getLugar()) + " noong " + convertDate(temp.getPetsa());
    } else if(temp.getLugar()!=null & temp.getMagnitude()!=null & temp.getPetsa()!=null){
		return "Lindol na may lakas na " + temp.getMagnitude() + " tumama sa " + temp.getLugar();
        ...
        return "Isang malakas na lindol ang tumama sa " + temp.getLugar();
    }
	else{
		return "";
	}
